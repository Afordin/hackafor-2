...
const VARIANT_SECONDARY_STYLE =
  'bg-gradient-to-rb from-[#FC1C37] to-[#AD40E1] text-[16px] text-cWhite rounded-full hover:from-cWhite hover:to-cWhite hover:text-cBlack font-bold px-[14px] py-[10px]'

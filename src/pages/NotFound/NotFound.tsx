...
export const NotFound = () => {
  return (
    <RootLayout>
      <Background />
      <main
        className="relative z-2 w-full max-w-7xl mx-auto flex justify-center 
      items-center h-[87svh] text-cWhite font-dmsans"
      >
        <article className="px-5">
          <section className="space-y-lg text-shadow-md">
